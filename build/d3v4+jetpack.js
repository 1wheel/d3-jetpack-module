...
var   svgNode$1;
  ...
  var interpolateTransformCss = interpolateTransform$3(parseCss$1, "px, ", "px)", "deg)");
  var interpolateTransformSvg = interpolateTransform$3(parseSvg$1, ", ", ")", ")");
...
var   epsilon2$2 = 1e-12;
  ...
  var hcl$3 = hcl$2(hue$1);
  var hclLong$1 = hcl$2(nogamma$1);
...
var   t1$1 = new Date;
  ...
  function calendar(year, month, week, day, hour, minute, second, millisecond, format) {
    ...
    scale.domain = function(_) {
      return arguments.length ? domain(map$2.call(_, number$3)) : domain().map(date$2);
    };
  ...
  function time() {
    return calendar(year, month, timeSunday, day, hour, minute, second, millisecond, exports.timeFormat).domain([new Date(2000, 0, 1), new Date(2000, 0, 2)]);
  }
  ...
  var cubehelix$5 = interpolateCubehelixLong(cubehelix(300, 0.5, 0.0), cubehelix(-240, 0.5, 1.0));
...
var   setFrame$1 = typeof requestAnimationFrame === "function" ? requestAnimationFrame : function(f) { setTimeout(f, 17); };
  ...
  function interval$3(callback, delay, time) {
  ...
  function conventions(c){
    ...
    c.x = c.x || linear$3().range([0, c.width])
    c.y = c.y || linear$3().range([c.height, 0])
  ...
  exports.interpolateHsl = hsl$3;
  exports.interpolateHslLong = hslLong$1;
  exports.interpolateLab = lab$2;
  exports.interpolateHcl = hcl$3;
  exports.interpolateHclLong = hclLong$1;
  exports.interpolateCubehelix = cubehelix$4;
  ...
  exports.interpolateCubehelixDefault = cubehelix$5;
  ...
  exports.timeout = timeout$3;
  exports.interval = interval$3;
